// The pallas series: the language itself, six pages past the kernel path's
// stage-1 chapter. Grounded in the Pallas design document and the TPU
// references; repo captures quoted are jax 0.4.38 with debug=True, and the
// two authored snippets ran under interpret mode before shipping.
import type { Series } from './index'

export const PALLAS_SERIES: Series = {
  id: 'pallas',
  title: 'Pallas, the language',
  lede: 'The kernel path taught you to write Pallas. This series is about why the language is shaped the way it is, and what the shape lets you state.',
  deepens: [
    { label: 'stage 1 · pallas fundamentals', href: '/s/pallas' },
    { label: 'ch 06 · pallas, the layer', href: '/l/pallas' },
    { label: 'ch 07 · mosaic, the layer', href: '/l/mosaic' },
  ],
  pages: [
    {
      ...
      sections: [
        {
          ...
          ps: [
            ...
            'The kernel path already had you writing Pallas by week two, at /s/pallas, without ever asking why the language exists in this shape. That question is this page.',
          ],
        },
        {
      ...
      readings: [
        {
          ...
          note: 'the argument this page is built on; read the motivation section first',
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          ps: [
            ...
            'Now the distinction that governs everything on this page. A branch in the body decides what happens to a block; it cannot decide whether the block arrives. The copy was issued by the pipeline emitter from the index map, before your body ran. Wrapping compute in `pl.when` saves the compute and pays the transfer anyway.',
        ...
        },
        {
          ...
          ps: [
            ...
            'What cannot be data is the tile the vector registers are laid out for. That is the lattice from page 3, and no amount of prefetching relaxes it. So the ragged kernel you write is not a kernel with a variable shape; it is a kernel with a fixed shape whose schedule was computed at run time.',
      ...
      readings: [
        {
          ...
          note: 'the signatures, the prefetch map, and the DSD kernel this page reads',
        },
        {
...

    {
      ...
      sections: [
        ...
        },
        {
          ...
          ps: [
            'Mosaic consumes mostly standard-dialect MLIR and emits LLO to be compiled for the TPU. Pallas gets there by translating JAX primitives into MLIR, mostly the `vector` and `arith` dialects, and by converting the `BlockSpec`s into the pipeline schedules that page 4 read out of the module\'s attributes.',
        ...
        },
        {
          ...
          ps: [
            ...
            'That arithmetic is what the block index abstraction removed. Page 3 spent its first section on the fact that an index map returns block coordinates and Pallas does the multiplication; this is the layer where you can see who used to do it and what they had to say instead.',
          ],
        },
        {
