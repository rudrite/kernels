// The machine series: the hardware under every kernel in this course, TPU
// and GPU both, at a depth the path's stage 0 does not attempt. Chip
// constants come from the scaling book and are quoted with their units;
// nothing on these pages is measured here, so nothing claims to be.
import type { Series } from './index'

export const MACHINE_SERIES: Series = {
  id: 'machine',
  title: 'The machine',
  lede: 'Two chips, two fabrics, one job. What the silicon actually does with your matmul, in enough detail to predict it.',
  deepens: [
    { label: 'stage 0 · the machine', href: '/s/machine' },
    { label: 'ch 08 · tpu, the layer', href: '/l/tpu' },
    { label: 'ch 09 · ici, the layer', href: '/l/ici' },
  ],
  pages: [
    {
      id: 'tpu-chip',
      ...
      sections: [
        {
          ...
          ps: [
            ...
            'The commitment shows up in what is missing. There is no branch predictor to speak of, no out-of-order engine, no hardware cache deciding for you what stays close to the compute. When this course later has you choreograph data by hand with a `BlockSpec`, this page is the reason: the hardware chose not to guess, which means someone has to say. On a TPU that someone is the compiler, and in Pallas it is you.',
          ],
        },
        {
      ...
      readings: [
        { label: 'Scaling book · All about TPUs', url: 'https://jax-ml.github.io/scaling-book/tpus/', note: 'the backbone text; every constant on this page lives in its tables' },
      ...
      sections: [
        ...
        },
        {
          ...
          ps: [
            ...
            "Hold that straight and the rest of the vocabulary lines up cleanly: warp scheduler against VPU, CUDA core against VPU ALU, SMEM against VMEM, HBM against HBM. Page 6 puts the counts side by side, which is where the two designs stop looking alike.",
          ],
        },
      ],
      readings: [
        {
          ...
          note: "every number on this page comes from here; start at the SM section",
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          ps: [
            ...
            "The algebra is identical in both cases. What changes is who does the staging, which is the same split you have been reading about since the top of this page.",
          ],
        },
        {
      ...
      readings: [
        {
          label: "Scaling book · How to think about GPUs",
          url: "https://jax-ml.github.io/scaling-book/gpus/",
          note: "the chip-level comparison table this page is built on",
        },
        {
