...
export const DIAGRAMS: Record<string, DiagramSpec> = {
  ...
  'mosaic-boundary': {
    ...
    els: [
      ...
      { k: 'text', x: 363, y: 170, t: 'debug=True prints both', tone: 'copper', size: 10, anchor: 'middle' },
      { k: 'line', x1: 200, y1: 152, x2: 526, y2: 152, tone: 'mute', dash: true },
  ...
  'profile-loop': {
    w: 720,
    h: 260,
    alt: 'The four-beat performance loop: predict from constants, profile the run, attribute the gap op by op, fix one thing, and back to predict',
    caption: 'the loop this whole course runs: the attribute beat is the one people skip, and skipping it turns the rest into guessing',
    els: [
      { k: 'box', x: 40, y: 90, w: 140, h: 70, t: 'predict', s: 'from chip constants\nbefore any run', tone: 'ink' },
      { k: 'line', x1: 180, y1: 125, x2: 220, y2: 125, a: 'end', tone: 'mute' },
      { k: 'box', x: 220, y: 90, w: 140, h: 70, t: 'profile', s: 'capture the device\ntimeline, steady state', tone: 'steel' },
      { k: 'line', x1: 360, y1: 125, x2: 400, y2: 125, a: 'end', tone: 'mute' },
      { k: 'box', x: 400, y: 90, w: 140, h: 70, t: 'attribute', s: 'the gap, op by op\nnamed, not guessed', tone: 'copper' },
      { k: 'line', x1: 540, y1: 125, x2: 580, y2: 125, a: 'end', tone: 'mute' },
      { k: 'box', x: 580, y: 90, w: 110, h: 70, t: 'fix one\nthing', tone: 'ink' },
      { k: 'line', x1: 635, y1: 160, x2: 635, y2: 210, tone: 'copper' },
      { k: 'line', x1: 635, y1: 210, x2: 110, y2: 210, tone: 'copper' },
      { k: 'line', x1: 110, y1: 210, x2: 110, y2: 160, a: 'end', tone: 'copper', t: 'measure again: the loop is the method', lx: 372, ly: 232 },
      { k: 'text', x: 40, y: 52, t: 'an unattributed gap is a guess wearing a number', tone: 'copper', size: 11 },
    ],
  },
  ...
  'three-accounts': {
    w: 720,
    h: 320,
    alt: 'The three accounts of one program: the cost model which undercounted, the hardware timeline, and measured achieved bandwidth, with the last two converging on 280.2 MB against the 276.8 MB estimate',
    caption: 'three tellings of the same program, with the numbers this site measured: the models argue, the hardware referees',
    els: [
      { k: 'box', x: 24, y: 44, w: 200, h: 92, t: 'the cost model', s: 'compiled.cost_analysis()\nsaid 155.2 MB\nblind inside custom calls', tone: 'mute', dash: true },
      { k: 'box', x: 260, y: 44, w: 200, h: 92, t: 'the device timeline', s: 'hardware time, per op\n217.6 µs on the S ops\ntruth for time, not bytes', tone: 'steel' },
      { k: 'box', x: 496, y: 44, w: 200, h: 92, t: 'achieved bandwidth', s: 'a pure 1 GB copy, timed\n1287.5 GB/s = 80.5%\nof the nameplate ceiling', tone: 'steel' },
      { k: 'line', x1: 360, y1: 136, x2: 360, y2: 196, a: 'end', tone: 'copper', w: 2 },
      { k: 'line', x1: 596, y1: 136, x2: 596, y2: 168, tone: 'copper', w: 2 },
      { k: 'line', x1: 596, y1: 168, x2: 400, y2: 208, a: 'end', tone: 'copper', w: 2 },
      { k: 'line', x1: 124, y1: 136, x2: 124, y2: 226, dash: true, tone: 'mute', t: 'excluded: cannot see the custom call', lx: 130, ly: 250 },
      { k: 'box', x: 260, y: 196, w: 260, h: 76, t: 'time × achieved rate', s: '280.2 MB vs 276.8 estimated\nagreement within 1.2%', tone: 'copper' },
      { k: 'text', x: 696, y: 306, t: 'gate 02, closed by this arithmetic · rows M-018 to M-023 on the bench', anchor: 'end', size: 9.5 },
    ],
  },
  ...
  'xspace-anatomy': {
    w: 720,
    h: 300,
    alt: 'The XSpace container holding planes for the device and hosts, each plane holding lines, each line holding timed events with metadata and stats',
    caption: 'what a capture actually is: one container, planes per device and host, lines per stream, timed events. GYM 08 is forty lines of reading this.',
    els: [
      { k: 'box', x: 24, y: 30, w: 672, h: 250, t: '', tone: 'mute', dash: true },
      { k: 'text', x: 40, y: 56, t: 'XSpace · one file per host', tone: 'ink', size: 12 },
      { k: 'box', x: 40, y: 72, w: 320, h: 190, t: '', tone: 'ink' },
      { k: 'text', x: 56, y: 96, t: 'plane /device:TPU:0', tone: 'copper', size: 11 },
      { k: 'box', x: 56, y: 108, w: 288, h: 60, t: 'line: op stream', s: 'events: %fusion 89.6 µs · %online-softmax 128.0 µs', tone: 'copper' },
      { k: 'box', x: 56, y: 178, w: 288, h: 40, t: 'line: counters', s: 'throttle and FIFO samples', tone: 'mute' },
      { k: 'text', x: 56, y: 244, t: 'hardware truth lives here', size: 9.5 },
      { k: 'box', x: 392, y: 72, w: 288, h: 88, t: 'plane /host:CPU', s: 'python, dispatch, callbacks\nwhere input pipelines stall', tone: 'steel' },
      { k: 'box', x: 392, y: 174, w: 288, h: 88, t: 'event metadata + stats', s: 'names, HLO text, per-event\nkey-value stats', tone: 'mute' },
    ],
  },
}
