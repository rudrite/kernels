    ...
    "sections": [
      {
        ...
        "ps": [
          ...
          "And when the prose below names a function, the code is one scroll away: two guided walks at the bottom of this page step through actual implementations line by line, first LAB·X5's mock plugin keeping every PJRT promise in plain C, then the real IFRT adapter from the tree keeping its promises by delegation. Read a section, then watch its functions do the thing."
        ]
      },
      {
