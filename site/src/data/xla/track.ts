    ...
    "sections": [
      ...
      },
      {
        ...
        "ps": [
          ...
          "That leaves the experiment chapter 5 wanted, finally pointed at the right stage. Disable `tpu_fusion`, confirm the module moved, and time both versions. One caveat carries over from the measurement half: with a 35 percent spread across identical processes, that comparison needs many repeats before any ratio means anything, which is a different and more careful experiment than the one this section retracted."
        ]
      }
    ],
    "readings": [
